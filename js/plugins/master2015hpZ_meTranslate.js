...
master2015hp.translator.a = PluginManager.parameters('master2015hpZ_meTranslate');
...
console.log(master2015hp.translator.a['special encode list']);
...
Window_Language.prototype.initialize = function() {
    ...
    Window_Selectable.prototype.initialize.call(this, new Rectangle(x,y,w,h));//MZ
	this.openness = 0;
};
...
//patch Yep_CallEvent
if (typeof Imported != 'undefined' && Imported.YEP_CallEvent) {
